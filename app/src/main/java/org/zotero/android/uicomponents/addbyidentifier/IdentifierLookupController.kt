...
class IdentifierLookupController @Inject constructor(
    ...
    private val lookupTotalCount: Int get() {
        return lookupData.size
    }
    private val lookupRemainingCount: Int get() {
    ...
    val observable = EventStream<Update>(
...
//                    process(result.value!!)//TODO
    ...
    fun initialize(
        libraryId: LibraryIdentifier,
        collectionKeys: Set<String>,
        completion: (List<LookupData>?) -> Void
    ) {
        val lookupSettings =
    ...
    data class LookupData(
        ...
        sealed class State {
            ...
            object failed : State()
            data class translated(val q: TranslatedLookupData) : State()
