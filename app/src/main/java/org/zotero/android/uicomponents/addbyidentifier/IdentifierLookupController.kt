...
class IdentifierLookupController @Inject constructor(
    ...
    private fun setupObserver(lookupWebViewHandler: LookupWebCallChainExecutor) {
        ...
        fun process(result: Result<org.zotero.android.uicomponents.addbyidentifier.data.LookupData>) {
            ...
            fun process(data: org.zotero.android.uicomponents.addbyidentifier.data.LookupData) {
                when (data) {
                    is org.zotero.android.uicomponents.addbyidentifier.data.LookupData.identifiers -> {
                    ...
                    is org.zotero.android.uicomponents.addbyidentifier.data.LookupData.item -> {
