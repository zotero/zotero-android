package org.zotero.android.loaders.utilities
...
class UtilitiesLoader @Inject constructor(
    ...
    private fun _update() {
        ...
        Timber.Forest.i("UtilitiesLoader: update utilities JS")
        try {
    ...
    private fun _updateFromBundle(forceUpdate: Boolean) {
        ...
        Timber.Forest.i("UtilitiesLoader: should update utilities from bundle, forceUpdate=$forceUpdate; oldHash=${defaults.getLastUtilitiesCommitHash()}; newHash=$hash")
        if (!forceUpdate && defaults.getLastUtilitiesCommitHash() == hash) {
            return
        }
        Timber.Forest.i("UtilitiesLoader: update utilities from bundle")
        updateUtilities()
    ...
    private fun updateFromBundle() {
        try {
            ...
            Timber.Forest.e(error, "UtilitiesLoader: can't update from bundle")
        ...
        try {
            if (!fileStore.utilitiesDirectory().exists()) {
                if (type != UpdateType.initial) {
                    Timber.Forest.e("UtilitiesLoader: utilities directory was missing!")
                }
            ...
            Timber.Forest.e(error, "UtilitiesLoader: unable to restore folder integrity")
            throw error
        }
    ...
    private fun process(error: Exception) {
        Timber.Forest.e(error, "UtilitiesLoader: error")
