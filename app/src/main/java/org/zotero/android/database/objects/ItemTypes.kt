...
class ItemTypes {
    companion object {
        ...
        fun iconName(rawType: String, attachmentData: AttachmentData? = null): String {
            when (rawType) {
                "artwork" -> {
                ...
                "attachment" -> {
                    ...
                    when (attachmentData.contentType) {
                        "pdf" -> {
                            return if (attachmentData.linked) {
                                "item_type_pdflinked"
                            } else {
                                "item_type_pdf"
                            }
