...
import org.zotero.android.screens.htmlepub.reader.sidebar.annotations.cache.HtmlEpubAnnotationBitmapMemoryCache
...
class HtmlEpubAnnotationBitmapManager @Inject constructor(
    ...
    private val htmlEpubThumbnailPreviewCacheSnapshotEventStream: HtmlEpubAnnotationBitmapCacheSnapshotEventStream,
//    private val htmlEpubRequestThumbnailRenderEventStream: HtmlEpubRequestThumbnailRenderEventStream,
    ...
    fun store(key: String, encodedImageBase64String: String) {
        Timber.d("HtmlEpubThumbnailProcessing: store - $key")
        enqueue(
            key = key,
    ...
    private fun convertAndPostResults(
        ...
        htmlEpubThumbnailPreviewCacheSnapshotEventStream.emitAsync(resultCache.toPersistentMap())
    }
