...
class TranslatorWebViewHandler @Inject constructor(
    ...
    suspend fun sendMessaging(payload: Map<String, Any>, messageId: Long) {
        return suspendCancellableCoroutine { cont ->
            val encodedPayload = encodeAsJSONForJavascript(gson = gson, data = payload)
...
//        val timeout: Double = options["timeout"]?.asDouble?.let { it/1000.0 } ?:60.0
